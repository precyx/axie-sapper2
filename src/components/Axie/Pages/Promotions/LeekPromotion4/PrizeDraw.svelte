<script>
  ...
  let axies = [
    // land
    { id: "-55/-135", status: "a", type: "land-arctic", color:"grey" },
    // whale
    { id: "whale-15", status: "a", type: "currency-whale", color:"blue", count:"15" },
    // 1337
    { id: "whale-1337-50", status: "a", type: "currency-1337", color:"blue", count:"50" },
    // ETH
    { id: "eth-0.0815-1", status: "a", type: "currency-eth", color:"blue", count:"0.0815" },
    { id: "eth-0.0815-2", status: "a", type: "currency-eth", color:"blue", count:"0.0815" },
    { id: "eth-0.0815-3", status: "a", type: "currency-eth", color:"blue", count:"0.0815" },
    { id: "eth-0.0815-4", status: "a", type: "currency-eth", color:"blue", count:"0.0815" },
  ];
...
<div class="leek-pool-promotion">
  ...
  <h1 class="infobar text-dark-2">Whaxie 3.0 - Saturday</h1>
