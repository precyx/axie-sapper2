<script>
  ...
  let axies = [
    ...
    // axies
    { id: "90665", status: "a", type: "axie", color:"white" },
    { id: "116594", status: "a", type: "axie", color:"blue" },
    { id: "72523", status: "a", type: "axie", color:"blue" },
    { id: "88905", status: "a", type: "axie", color:"green" },
    // land
    { id: "-55/-135", status: "a", type: "land-forest", color:"grey" },
    // whale
    { id: "whale-20", status: "a", type: "currency-whale", color:"blue", count:"20" },
    // ETH
    { id: "eth-0.5", status: "a", type: "currency-eth", color:"blue", count:"0.5" },
    // SLP
    { id: "slp-1000", status: "a", type: "currency-slp", color:"blue", count:"1000" },
  ];
  ...
  // prettier-ignore
  let winners = [
    {name:"that jdor guy", axies:[], tickets:1},
